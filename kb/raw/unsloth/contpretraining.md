---
source_url: https://unsloth.ai/blog/contpretraining
slug: contpretraining
title: "Continued LLM Pretraining with Unsloth"
...
-                                  Continued LLM Pretraining with Unsloth   {"@context":"https://schema.org","@type":"WebSite","name":"Unsloth - Train and Run Models Locally","url":"https://unsloth.ai"}
...
## By Daniel & Michael
Unsloth’s new release allows you to easily continually pretrain LLMs   2x faster   and use   50% less VRAM   than Hugging Face + Flash Attention 2 QLoRA. We've released a [free Colab notebook](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Mistral_v0.3_(7B)-CPT.ipynb) to continually pretrain Mistral v0.3 7b to   learn a new language like Korean   and another Colab for [text completion](https://colab.research.google.com/github/unslothai/notebooks/blob/main/nb/Mistral_(7B)-Text_Completion.ipynb)!  We provide the following insights:   You should finetune the input and output embeddings.
...
Model    VRAM     🦥 Unsloth speed     🦥  VRAM reduction     🦥  Longer context     🤗 Hugging Face+FA2       Llama-3 8B    24GB    2x    52%    3x longer    1x      Llama-3 70B    80GB    1.9x    49%    6x longer    1x       We used QLoRA and trained on all linear layers (including the embed_tokens and lm_head) and used a rank of 256 on a L4 GPU.    ♻️ But what is Continued Pretraining?    Continued or continual pretraining (CPT) is necessary to “steer” the language model to understand new domains of knowledge, or out of distribution domains. Base models like Llama-3 8b or Mistral 7b are first pretrained on gigantic datasets of trillions of tokens (Llama-3 for eg is 15 trillion). But sometimes these models have not been well trained on other languages, or text specific domains, like law, medicine or other areas. So continued pretraining (CPT) is necessary to make the language model learn new tokens or datasets.    📖 LoRA Learns Less & Forgets Less    [A recent paper](https://arxiv.org/abs/2405.09673) showed how using LoRA is inferior to full finetuning when doing continual pretraining. We tweeted about how we can improve upon the paper [here:](https://twitter.com/twitter/status/1791900967472140583)
...
window.__remixContext = {"basename":"/","future":{"v3_fetcherPersist":false,"v3_relativeSplatPath":false,"v3_throwAbortReason":false,"v3_routeConfig":false,"v3_singleFetch":false,"v3_lazyRouteDiscovery":false,"unstable_optimizeDeps":false},"isSpaMode":false,"state":{"loaderData":{"root":null,"routes/[blog].[contpretraining]._index":{"host":"unsloth.ai","url":"https://unsloth.ai/blog/contpretraining","system":{"params":{},"search":{},"origin":"https://unsloth.ai","pathname":"/blog/contpretraining"},"resources":{},"pageMeta":{"title":"Continued LLM Pretraining with Unsloth","description":"Make a model learn a new language by doing continued pretraining with Unsloth using Llama 3, Phi-3 and Mistral.","excludePageFromSearch":false,"socialImageAssetName":"continued_pretraining_small_fyxy-w3imhCLjbB3PMerC.png","custom":[]}}},"actionData":null,"errors":null}};  import "/assets/manifest-64340927.js";
import * as route0 from "/assets/root-Bi8uDDMw.js";
import * as route1 from "/assets/_blog_._contpretraining_._index-BD3rmNYA.js";

window.__remixRouteModules = {"root":route0,"routes/[blog].[contpretraining]._index":route1};
