...
- **Primary GGUF Artifact**: `Qwen2.5-32B-Instruct-Q4_K_S.gguf` (18.78 GB / 20,165,165,472 bytes)
...
- **Single RTX 3090 / 3090 Ti (24GB)**: ~24.5 tok/s generation throughput (reliable baseline dense throughput).
- **Dual RTX 3090 / 3090 Ti (2x24GB)**: ~44.0 tok/s in tensor parallel.
- **Mac Studio M4 Max (128GB)**: ~29.5 tok/s in Metal backend.
...
- **Baseline Stability**: Established industry-standard general instruction model with predictable token output and mature prompt template support across all inference runtimes.
